...
LOCAL_APPS = [
    ...
    "mysite.organization.apps.OrganizationConfig"
]
...
ACCOUNT_FORMS = {
    'signup': 'mysite.users.forms.CustomSignupForm',
    'login': 'mysite.users.forms.CustomLoginForm'
}